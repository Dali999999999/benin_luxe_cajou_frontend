...
function renderSectionContent(id) {
    const content = {
        ...
        retractation: "Conformément à la législation en vigueur, le Client dispose d'un délai de 3 jours à compter de la réception de ses produits pour exercer son droit de rétractation sans avoir à justifier de motifs ni à payer de pénalité. Les produits doivent être retournés dans leur état d'origine.",
